...
<head>
	...
	<title>Log In | <?= ($cfg->_namaApp ?: "Silihay") ?></title>
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<!-- <img src="<?= base_url() ?>/img/avatars/avatar.jpg" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" /> -->
									</div>
                                    ...
                                    ?>
										<div class="mb-3">
											...
											<input 
                                                autofill="false" 
                                                class="form-control <?= $is_inv_username ?>"  
                                                autofocus="true" 
                                                required="true" 
                                                type="text" 
                                                name="username" 
										...
										<div class="mb-3">
											...
											<input 
                                                autofill="false" 
                                                class="form-control <?= $is_inv_password ?>" 
                                                type="password" 
                                                name="password" 
